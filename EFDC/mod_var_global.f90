...
MODULE GLOBAL
  ...
  INTEGER :: IDRYTBP
  ! INTEGER :: IG ** No longer used in writing out, replaced by ic
  INTEGER :: IGM
  INTEGER :: IHYDOUT
  INTEGER :: IINTPG
  INTEGER :: IMORPH
  ...
  INTEGER :: NFIELD
  INTEGER :: NFLTMT
  INTEGER :: NGRPID                 !< NUMBER OF UNIQUE FLOW GOUNARY GROUPS
  INTEGER :: NGLM
  INTEGER :: NGWSER
  INTEGER :: NGWSERM
  INTEGER :: NHAR
  ...
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ICBE       !< I INDEX OF EAST OPEN BOUNDARY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ICBN       !< I INDES OF NORTH OPEN BOUNDARY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ICBS       !< I INDEX OF SOUTH OPEN BOUNDAY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ICBW       !< I INDEX OF WEST OPEN BOUNBDARY
  ...
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: IPBE       !< I INDEX OF EAST OPEN BOUNDARY CELL
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: IPBN       !< I INDEX OF NORTH OPEN BOUNDARY CELL
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: IPBS       !< I INDEX OF SOUTH OPEN BOUNDARY CELL
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: IPBW       !< I INDEX OF WEST OPEN BOUNDARY CELL
  ...
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ISPBE      !< I INDEX OF EAST CONCENTRATION OPEN BOUNDARY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ISPBN      !< I INDEX OF NORTH CONCENTRATION OPEN BOUNDARY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ISPBS      !< I INDEX OF SOUTH CONCENTRATION OPEN BOUNDARY
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: ISPBW      !< I INDEX OF WEST CONCENTRATION OPEN BOUNDARY
  ...
  INTEGER,ALLOCATABLE,DIMENSION(:,:)   :: ITXPARB    !< BED SEDIMENT-TOXICS PARTITIONING OPTION FLAG
  INTEGER,ALLOCATABLE,DIMENSION(:,:)   :: ITXPARBC   !< BED OC-TOXICS PARTITIONING OPTION FLAG
  ...
  INTEGER,ALLOCATABLE,DIMENSION(:)     :: JCPSL      !< WATEER QUALITY MODEL VARIABLE
  ...
  REAL :: DSFLMN(100)
  REAL :: DSFLMX(100)
  REAL :: FUNKH(1001)   !1< TEMPORARY FLUX VARIALBE
  REAL :: RKDSFL(100)
  REAL :: RKHTAB(1001)
  REAL :: SBPLTV(7)
  REAL :: SFATBT(100)
  ...
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: CONPARB       !< CONCENTRATION FOR CONCENTRATION DEPENDENT SED-TOXIC PARTITIONING IN BED
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: CONPARBC      !< CONCENTRATION FOR CONCENTRATION DEPENDENT OC-TOXIC PARTITIONING IN BED
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: CONPARW       !< CONCENTRATION FOR CONCENTRATION DEPENDENT SED-TOXIC PARTITIONING IN WATER COLUMN
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: CONPARWC      !< CONCENTRATION FOR CONCENTRATION DEPENDENT OC-TOXIC PARTITIONING IN WATER COLUMN
  ...
  REAL,ALLOCATABLE,DIMENSION(:,:,:) :: TOXFB        !< INITIAL VALUE OF TOX
  ...
  REAL,ALLOCATABLE,DIMENSION(:)     :: TOXINTB      !< INITIAL TOXIC CONTAMIANT CONCENTRATION IN BED M/L*L
  REAL,ALLOCATABLE,DIMENSION(:)     :: TOXINTW      !< INITIAL TOXIC CONTAMIANT CONCENTRATION IN WATER COLUMN M/L*L*L
  ...
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: TOXPARB      !< SED-TOX PARTITION COEFFICIENT IN BED L*L/M
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: TOXPARBC     !< OC-TOX PARTITION COEFFICIENT IN BED L*L/M
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: TOXPARW      !< SED-TOXIC PARTITION COEFFICIENT IN WATER COLUMN L*LL/M
  REAL,ALLOCATABLE,DIMENSION(:,:)   :: TOXPARWC     !< OC-TOXIC PARTITION COEFFICIENT IN WATER COLUMN L*L*L/M
  REAL,ALLOCATABLE,DIMENSION(:,:,:,:) :: TOXPFB     !< TOXIC PARTICULATE PHASE FRACTION IN BED
  REAL,ALLOCATABLE,DIMENSION(:,:,:) :: TOXPFTB      !< TOTAL TOXIC PARTICULATE PHASE FRACTION IN WATER COLUMN
  REAL,ALLOCATABLE,DIMENSION(:,:,:) :: TOXPFTW      !< TOXPFTW
  REAL,ALLOCATABLE,DIMENSION(:,:,:,:) :: TOXPFW     !< TOXIC PARTICULATE PHASE FRACTION IN WATER COLUMN
  REAL,ALLOCATABLE,DIMENSION(:,:,:) :: TOXS         !< TEMPORARTY TOXIC CONTAMINANT CONCENTRATION IN WATER COLUMN  M/L*L*L 
  ...
  REAL,ALLOCATABLE,DIMENSION(:,:,:) :: VSLSHA       !< WATER QUALITY MODEL VARIABLE
