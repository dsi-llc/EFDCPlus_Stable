...
Module Variables_WQ
  ...
  TYPE ALGAECLASS
    ...
    REAL,ALLOCATABLE,DIMENSION(:)     :: WQKBP       !< Velocity limitation - Plant density half saturation factor   (G C/M2)
    ...
    REAL :: THRESHOLD      !< Concentration factor to convert macrophyte concentration to plant height (mg C/L/m)
    REAL :: HEIGHTMIN      !< Mimimum height above the cell bottom to allow macrophyte/periphyton growth (m)
    REAL :: HEIGHTMAX      !< Maximum height above the cell bottom to allow macrophyte/periphyton growth (m)
