...
SUBROUTINE LSQHARM
  ...
  REAL,SAVE,ALLOCATABLE,DIMENSION(:)     :: SLSHA
  REAL,SAVE,ALLOCATABLE,DIMENSION(:)     :: AMATMP
  REAL,SAVE,ALLOCATABLE,DIMENSION(:)     :: PPPTMP
  REAL,SAVE,ALLOCATABLE,DIMENSION(:,:)   :: B0
  REAL,SAVE,ALLOCATABLE,DIMENSION(:,:)   :: B1DT1
  REAL,SAVE,ALLOCATABLE,DIMENSION(:)     :: P0
  REAL,SAVE,ALLOCATABLE,DIMENSION(:,:,:) :: VSLSHA
  REAL,SAVE,ALLOCATABLE,DIMENSION(:,:)   :: VTLSHA
  REAL,SAVE,ALLOCATABLE,DIMENSION(:,:)   :: VVLSHA
  REAL,SAVE,ALLOCATABLE,DIMENSION(:)     :: WLSHA
  ...
  IF(  .NOT. ALLOCATED(AMATMP) )THEN
    ...
    Call AllocateDSI(VSLSHA, KCM, MLM, MTM, 0.0)
    Call AllocateDSI(VTLSHA, KCM, MLM, 0.0)
    Call AllocateDSI(VVLSHA, MGM, MGM, 0.0)
    Call AllocateDSI(WLSHA,  MGM, 0.0)
    SLSHA = 0.0
    AMATMP=0.0
    PPPTMP=0.0
    P0=0.0
