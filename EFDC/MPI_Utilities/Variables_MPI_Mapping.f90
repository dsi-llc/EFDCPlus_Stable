...
Module Variables_MPI_Mapping
  ...
  ! *** Jet/Plume mapping
   ...
   INTEGER, ALLOCATABLE, DIMENSION (:) :: ICALJP_GL
   INTEGER, ALLOCATABLE, DIMENSION (:) :: IQJP_GL
   INTEGER, ALLOCATABLE, DIMENSION (:) :: JQJP_GL
   INTEGER, ALLOCATABLE, DIMENSION (:) :: KQJP_GL
   INTEGER, ALLOCATABLE, DIMENSION (:) :: NPORTJP_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    XJETL_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    YJETL_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    ZJET_GL
   real, ALLOCATABLE, DIMENSION (:) ::    PHJET_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    THJET_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    DJET_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    CFRD_GL
   Real, ALLOCATABLE, DIMENSION (:) ::    DJPER_GL
