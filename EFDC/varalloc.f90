...
SUBROUTINE VARALLOC
  ...
  Call AllocateDSI( CBE,        NBBEM,      2,       NSTVM, 0.0)
  Call AllocateDSI( CBN,        NBBNM,      2,       NSTVM, 0.0)
  Call AllocateDSI( CBS,        NBBSM,      2,       NSTVM, 0.0)
  Call AllocateDSI( CBW,        NBBWM,      2,       NSTVM, 0.0)
  ...
  Call AllocateDSI( CLOE,       NBBEM,      KCM,     NSTVM,  0.0)
  Call AllocateDSI( CLON,       NBBNM,      KCM,     NSTVM,  0.0)
  Call AllocateDSI( CLOS,       NBBSM,      KCM,     NSTVM,  0.0)
  Call AllocateDSI( CLOUDT,     LCM, 0.0  )                  
  Call AllocateDSI( CLOW,       NBBWM,      KCM,     NSTVM,  0.0)
  Call AllocateDSI( CLSHA,      MTM,        0.0)             
  Call AllocateDSI( CMB,        KCM,        0.0)             
  Call AllocateDSI( CN,         LCM,        0.0)             
  Call AllocateDSI( CONGW,      LCM,        NSTVM,     0.0)  
  ...
  Call AllocateDSI( CQCJP,      KCM,        NQJPM,  -NSTVM,  0.0)
  Call AllocateDSI( CQS,        KCM,        NQSIJM,  NSTVM,  0.0)
  Call AllocateDSI( CQSE,       NSTVM,      0.0)     
  Call AllocateDSI( CQWR,       NQWRM,      NSTVM,     0.0)
  Call AllocateDSI( CQWRSER,    NDQWRSR,    NQWRSRM, NSTVM,  0.0)
  Call AllocateDSI( CQWRSERT,  -NQWRSRM,    NSTVM,     0.0)
  Call AllocateDSI( CS,         LCM,        0.0)
  Call AllocateDSI( CSERT,      KCM,       -NCSERM, -NSTVM,  0.0)
  ...
  Call AllocateDSI( CWRCJP,     NQJPM,    -NSTVM,    0.0)
  ...
  Call AllocateDSI( GWCSER,     NDGWSER,    NGWSERM,  NSTVM,  0.0)
  Call AllocateDSI( GWCSERT,   -NGWSERM,   -NSTVM,    0.0)
  ...
  Call AllocateDSI( MCSER,      NCSERM,    NSTVM,     0)
  Call AllocateDSI( MTSCLAST,   NCSERM,    NSTVM,     0)
  ...
  Call AllocateDSI( NCSERE,     NBBEM,     NSTVM,    0)
  Call AllocateDSI( NCSERJP,    NQJPM,    -NSTVM,    0)
  Call AllocateDSI( NCSERN,     NBBNM,     NSTVM,    0)
  Call AllocateDSI( NCSERQ,     NQSIJM,    NSTVM,    0)
  Call AllocateDSI( NCSERS,     NBBSM,     NSTVM,    0)
  Call AllocateDSI( NCSERW,     NBBWM,     NSTVM,    0)
  Call AllocateDSI( NSERWQ,     LCM,                  0)
  Call AllocateDSI( NGWSL,      LCM,                  0)
  Call AllocateDSI( NJEL,       NQJPM,                0)
  Call AllocateDSI( NJPMX,      NQJPM,                0)
  Call AllocateDSI( NLOE,       NBBEM,     KCM,       NSTVM,  0)
  Call AllocateDSI( NLON,       NBBNM,     KCM,       NSTVM,  0)
  Call AllocateDSI( NLOS,       NBBSM,     KCM,       NSTVM,  0)
  Call AllocateDSI( NLOW,       NBBWM,     KCM,       NSTVM,  0)
  ...
  Call AllocateDSI( TACSER,    NCSERM,     NSTVM,     0.0)
  ...
  Call AllocateDSI( ITXPARB,         NSTM,   NTXM,   0)
  Call AllocateDSI( ITXPARBC,        2,      NTXM,   0)
  Call AllocateDSI( ITXPARW,         NSTM,   NTXM,   0)
  Call AllocateDSI( ITXPARWC,        2,      NTXM,   0)
                                            
  Call AllocateDSI( CONPARB,         NSTM,   NTXM,  0.0)
  Call AllocateDSI( CONPARBC,        2,      NTXM,  0.0)
  Call AllocateDSI( CONPARW,         NSTM,   NTXM,  0.0)
  ...
  Call AllocateDSI( FPOCBST,         NSTM,   NTXM, 0.0)
  Call AllocateDSI( FPOCWST,         NSTM,   NTXM, 0.0)
  ...
  Call AllocateDSI( TOXPARB,         NSTM,   NTXM,    0.0)
  Call AllocateDSI( TOXPARBC,        2,      NTXM,    0.0)
  Call AllocateDSI( TOXPARW,         NSTM,   NTXM,    0.0)
  ...
  IF( ISTRAN(5) >= 1 .OR. ISBAL > 0 .OR. NTOX > 0 )THEN
    ...
    Call AllocateDSI( TOXFB,         LCM,    KBM,     NTXM,  0.0)    ! *** TOXIC CONTAMINANT FLUX IN THE SEDIMENT BED AND BED/WATER INTERFACE  (G/M2/S)
    ...
    Call AllocateDSI( TOXPFB,        LCM,    KBM,     NSTM+2,  NTXM,  0.0)
    Call AllocateDSI( TOXPFTB,       LCM,    KBM,     NTXM,    0.0)  
    Call AllocateDSI( TOXPFTW,       LCM,    KCM,     NTXM,    0.0)  
    Call AllocateDSI( TOXPFW,        LCM,    KCM,     NSTM+2,  NTXM,  0.0)
    Call AllocateDSI( TOXS,          LCM,    KCM,     NTXM,    0.0)
    Call AllocateDSI( TOXTMP,        LCM,   -KBM+1 ,  0.0)
  ENDIF   ! *** END OF TOXIC VARIABLE DECLARATIONS

  ! ** SED VARIABLES
  Call AllocateDSI( SED,      LCM,  KCM,  NSCM,  0.0)
  Call AllocateDSI( SED1,     LCM,  KCM,  NSCM,  0.0)

  IF( ISTRAN(6) >= 1 .OR. ISBAL > 0 .OR. NSED > 0 )THEN
    Call AllocateDSI( SED3DMAX,      NSTM,    0.0)
    Call AllocateDSI( SED3DMIN,      NSTM,    0.0)
    ...
    Call AllocateDSI( SEDEND2T,      NSTM,    0.0)
    Call AllocateDSI( SEDEND2TB,     NSTM,    0.0)
    Call AllocateDSI( SEDEND2TW,     NSTM,    0.0)
    Call AllocateDSI( SEDERE2T,      NSTM,    0.0)
    Call AllocateDSI( SEDERE2TB,     NSTM,    0.0)
    Call AllocateDSI( SEDERE2TW,     NSTM,    0.0)
    Call AllocateDSI( SEDERO2T,      NSTM,    0.0)
    Call AllocateDSI( SEDERO2TB,     NSTM,    0.0)
    Call AllocateDSI( SEDERO2TW,     NSTM,    0.0)
    Call AllocateDSI( SEDERR2T,      NSTM,    0.0)
    Call AllocateDSI( SEDERR2TB,     NSTM,    0.0)
    Call AllocateDSI( SEDERR2TW,     NSTM,    0.0)
    Call AllocateDSI( SEDF,          LCM,    -KCM,    NSTM,  0.0)      ! *** VERTICAL SED FLUX ACROSS CELL LAYER FACES (G/M2/S)
    Call AllocateDSI( SEDINIT,       LCM,     KCM,    NSTM,  0.0)
    Call AllocateDSI( SEDOUT2T,      NSTM,    0.0)
    Call AllocateDSI( SEDOUT2TB,     NSTM,    0.0)
    Call AllocateDSI( SEDOUT2TW,     NSTM,    0.0)
    Call AllocateDSI( SEDS,          LCM,     KCM,    NSTM,  0.0)
    Call AllocateDSI( SEDFLUX2T,     NSTM,    0.0)      
  ...
  ! *** EITHER SED OR SND
  Call AllocateDSI( IBLTAUC,       NSTM,     0)
  Call AllocateDSI( ISEDWU,        NSTM,     0)
  Call AllocateDSI( IROUSE,        NSTM,     0)
  Call AllocateDSI( ISBDLD,        NSTM,     0)
  Call AllocateDSI( ISEDSCOR,      NSTM,     0)
  Call AllocateDSI( ISLTAUC,       NSTM,     0)
  Call AllocateDSI( ISNDEQ,        NSTM,     0)
  Call AllocateDSI( ISNDM1,        NSTM,     0)
  Call AllocateDSI( ISNDM2,        NSTM,     0)
  Call AllocateDSI( IWRSPB,        NSTM,     0)
  Call AllocateDSI( ISPROBDEP,     NSTM,     0)
                                         
  Call AllocateDSI( COSEDHID,      NSTM,   0.0)
  Call AllocateDSI( RSNDM,         NSTM,   0.0)
  Call AllocateDSI( SDBLV,         NSTM,   0.0)
  Call AllocateDSI( SDEN,          NSTM,   0.0)               ! ***  SPECIFIC VOLUME OF EACH SEDIMENT CLASS (M3/G)
  Call AllocateDSI( SEDN,          NSTM,   0.0)
  Call AllocateDSI( SEDO,          NSTM,   0.0)
  Call AllocateDSI( SEDBO,         NSTM,   0.0)
  Call AllocateDSI( SEDDIA,        NSTM,   0.0)
  Call AllocateDSI( SEXP,          NSTM,   0.0)
  Call AllocateDSI( SSG,           NSTM,   0.0)
  Call AllocateDSI( TAUD,          NSTM,   0.0)
  Call AllocateDSI( TAUN,          NSTM,   0.0)
  Call AllocateDSI( TAUR,          NSTM,   0.0)
  Call AllocateDSI( TCSHIELDS,     NSTM,   0.0)
  Call AllocateDSI( TEXP,          NSTM,   0.0)
  Call AllocateDSI( VDRDEPO,       NSTM,   0.0)
  Call AllocateDSI( WRSPO,         NSTM,   0.0)
  Call AllocateDSI( WSEDO,         NSTM,   0.0)
  Call AllocateDSI( VDRRSPO,       NSTM,   0.0)
  ...
  IF( ISTRAN(6) >= 1 .OR. ISTRAN(7) >= 1 .OR. ISBAL > 0 )THEN
    ...
    Call AllocateDSI( QSBDLDOT,    LCM,       MAX(NSNM, NSCM),  0.0)    ! *** BEDLOAD FLUX OUT DUE TO FIXING BOUNDARY CONDITION CELLS TO ZERO BEDLOAD DELTA  (G/S)
    Call AllocateDSI( QSBDLDX,     LCM,       MAX(NSNM, NSCM),  0.0)    ! *** U FACE SND FLUX DUE TO BEDLOAD (G/S)
    Call AllocateDSI( QSBDLDY,     LCM,       MAX(NSNM, NSCM),  0.0)    ! *** V FACE SND FLUX DUE TO BEDLOAD (G/S)
    ...
    Call AllocateDSI( QSEDBED,     LCM,       KBM,              NSTM,   0.0)
    Call AllocateDSI( QSEDBED1,    LCM,       KBM,              NSTM,   0.0)
    Call AllocateDSI( QSEDBEDA,    LCM,       NSTM,             0.0)
    Call AllocateDSI( QSEDBEDA1,   LCM,       NSTM,             0.0)
                                             
    Call AllocateDSI( SEDDIA50,    LCM,       KBM, 0.0)
    Call AllocateDSI( SEDDIA90,    LCM,       KBM, 0.0)
                                             
    Call AllocateDSI( SEDB,        LCM,       KBM,        NSTM,  0.0)
    Call AllocateDSI( SEDB1,       LCM,       KBM,        NSTM,  0.0)
    Call AllocateDSI( SEDBT,       LCM,       KBM,        0.0)
    Call AllocateDSI( SEDFPA,      LCM,       NSTM,       0.0)
    ...
    Call AllocateDSI( VFRBED,      LCM,       KBM,     NSTM,   0.0)
    Call AllocateDSI( VFRBED1,     LCM,       KBM,     NSTM,   0.0)
    Call AllocateDSI( VOLBW2,      LCM,       KBM,     0.0)
    Call AllocateDSI( VOLBW3,      LCM,       KBM,     0.0)
    Call AllocateDSI( WSETA,       LCM,      -KCM,     NSTM,   0.0)
    ...
    Call AllocateDSI( RSEDERE2T,   NSTM,      0.0)
    Call AllocateDSI( RSEDERE2TB,  NSTM,      0.0)
    Call AllocateDSI( RSEDERE2TW,  NSTM,      0.0)
    Call AllocateDSI( RSEDERO2T,   NSTM,      0.0)
    Call AllocateDSI( RSEDERO2TB,  NSTM,      0.0)
    Call AllocateDSI( RSEDERO2TW,  NSTM,      0.0)
    ...
    Call AllocateDSI( STFPOCB,     LCM,       KBM,     NSTM,   0.0)
    Call AllocateDSI( STFPOCW,     LCM,       KCM,     NSTM,   0.0)
  ...
  IF( ISSSMMT > 0 .OR. ISWASP > 0 )THEN
    ...
    IF( ISTRAN(5) > 0 )THEN
      ...
      Call AllocateDSI( TXPFLPF,   LCM,       KCM,  NSTM+2,   NTXM,  0.0)  ! ***
    ENDIF
    IF( ISTRAN(6) > 0 )THEN
      Call AllocateDSI( SEDBLPF,   LCM,       KBM,  NSTM,     0.0)
      Call AllocateDSI( SEDBTLPF,  LCM,       KBM,  0.0)      
      Call AllocateDSI( SEDLPF,    LCM,       KCM,  NSTM,     0.0)
  ...
  IF( LSEDZLJ )THEN
    ...
    Call AllocateDSI( ALPHA_RX,     LCM,    NSTM,      0.0)
    Call AllocateDSI( ALPHA_RY,     LCM,    NSTM,      0.0)
    Call AllocateDSI( BLFLAG,       LCM,    NSTM,      0)
    Call AllocateDSI( BULKDENS,     KB,     LCM,       0.0)
    Call AllocateDSI( D50,          NSTM,   0.0)
    Call AllocateDSI( D50AVG,       LCM,    0.0)
    Call AllocateDSI( DEPO,         LCM,    0.0)
    Call AllocateDSI( DISTAR,       NSTM,   0.0)
    Call AllocateDSI( DZBL,         LCM,    NSTM,       0.0)
    !ALLOCATE(DZBL_LAST(LCM, NS    CM2, 0.0)
    Call AllocateDSI( DWS,          NSTM,   0.0)
    Call AllocateDSI( DWSIN,        NSTM,   0.0)
    ...
    Call AllocateDSI( SSGI,         NSCM,  0.0)      
    ...
    Call AllocateDSI( TRANS,        LCM,    NSTM,     0.0)
  ...
  Call AllocateDSI( SEDFBEBKB,      LCM,       NSTM,     0.0)
  Call AllocateDSI( SEDFBECHB,      LCM,       NSTM,     0.0)
  Call AllocateDSI( SEDFBECHW,      LCM,       NSTM,     0.0)
  ...
  Call AllocateDSI( NCSERA,     NLDAM,     NSTVM,     0)
