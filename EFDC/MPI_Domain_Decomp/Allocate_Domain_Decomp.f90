...
Subroutine Allocate_Domain_Decomp
  ...
  Call AllocateDSI( GWCSER_Global,   NDGWSER, NGWSERM, NSTVM,  0.0)
  ...
  IF( ISTRAN(6) > 0 )THEN
    Call AllocateDSI( SED_Global,      LCM_Global, KCM, NSCM,  0.0)
    Call AllocateDSI( SED1_Global,     LCM_Global, KCM, NSCM,  0.0)
  ...
  Call AllocateDSI( NCSERS_GL,       NBBSM,    NSTVM,    0)
  Call AllocateDSI( CBS_GL,          NBBSM, 2, NSTVM,  0.0)
  Call AllocateDSI( ICBW_GL,         NBBWM,   0)
  Call AllocateDSI( JCBW_GL,         NBBWM,   0)
  Call AllocateDSI( NTSCRW_GL,       NBBWM,   0)
  Call AllocateDSI( NCSERW_GL,       NBBWM,    NSTVM,    0)
  Call AllocateDSI( CBW_GL,          NBBWM, 2, NSTVM,  0.0)
  Call AllocateDSI( ICBE_GL,         NBBEM,   0)
  Call AllocateDSI( JCBE_GL,         NBBEM,   0)
  Call AllocateDSI( NTSCRE_GL,       NBBEM,   0)
  Call AllocateDSI( NCSERE_GL,       NBBEM,    NSTVM,    0)
  Call AllocateDSI( CBE_GL,          NBBEM, 2, NSTVM,  0.0)
  Call AllocateDSI( ICBN_GL,         NBBNM,   0)
  Call AllocateDSI( JCBN_GL,         NBBNM,   0)
  Call AllocateDSI( NTSCRN_GL,       NBBNM,   0)
  Call AllocateDSI( NCSERN_GL,       NBBNM,    NSTVM,    0)
  Call AllocateDSI( CBN_GL,          NBBNM, 2, NSTVM,  0.0)
  ...
  Call AllocateDSI( NLOS_Global,     NBBSM, KCM, NSTVM,    0)
  Call AllocateDSI( NLOE_Global,     NBBEM, KCM, NSTVM,    0)
  Call AllocateDSI( NLOW_Global,     NBBWM, KCM, NSTVM,    0)
  Call AllocateDSI( NLON_Global,     NBBNM, KCM, NSTVM,    0)

  Call AllocateDSI( CLOS_Global,     NBBSM, KCM, NSTVM,  0.0)
  Call AllocateDSI( CLOE_Global,     NBBEM, KCM, NSTVM,  0.0)
  Call AllocateDSI( CLOW_Global,     NBBWM, KCM, NSTVM,  0.0)
  Call AllocateDSI( CLON_Global,     NBBNM, KCM, NSTVM,  0.0)
